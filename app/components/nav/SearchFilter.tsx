    ...
    <div className="h-12 lg:h-16 flex flex-row items-center justify-between lg:border rounded-full">
      <div className="hidden lg:block">
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-col min-w-fit justify-center w-64 h-16 px-6 rounded-full hover:bg-gray-100 cursor-pointer">
            <p className="text-xs font-semibold">Where</p>
            <p className="text-sm">Search Location</p>
          </div>
          <div className="flex flex-col min-w-fit justify-center h-16 px-6 rounded-full hover:bg-gray-100 cursor-pointer">
